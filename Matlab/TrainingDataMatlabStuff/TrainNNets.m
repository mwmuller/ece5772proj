...
nnet_5 = feedforwardnet([128 64]);
nnet_10 = feedforwardnet([256 128]);
nnet_20 = feedforwardnet([256 256]);
inputSize = 1000;
...
for i=(inputSize*.9+1):inputSize
    ...
    outputTest(4) = nnet_20(inputdata_20(i,:)');
    ...
    for j=1:4
        sqErr(i) = rms(actual(i) - outputTest(i));
        avgErr(i) = avgErr(i) + sqErr(i);
    end
end
